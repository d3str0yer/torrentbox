...
mkdir /home/qbtuser
chown qbtuser:qbtuser /home/qbtuser
...
#this shit doesn't work, ctrl c will stop the installation.....
#echo -e "${RED}########################################################${DEF}"
...
#doesn't work as pi, need to use qbtuser or find different solution. nah use qbtuser fuck it
smbpasswd -a pi
